...
public class PaperReviewDriver {
	...
	public static void main(String[] args) {
		...
		try {
			...
			conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/CONFERENCE_REVIEW", "root", "9441@Nani");
			...
			addNewPapSub(conn, "vinay@gmail.com", "Vinay", "Kasam", "Spring Boot", "Spring Boot is an open source Java-based framework used to create a micro Service", "boot_vinay");
	...
	public static void addNewPapSub(Connection conn, String authorEmail, String firstName, String lastName, String title, String abstract1, String filename) {
		Statement stmt = null;
		try {
			stmt = conn.createStatement();
